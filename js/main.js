...
d3.csv("./data/AIU-All-Women-Dataset-csv.csv", d => {
	...
	const toggleButton_2 = document.getElementById("button2");
	const myList_2 = document.getElementById("myList_2");

	toggleButton.addEventListener("click", function() {
	if (myList.style.display === "none") {
		myList.style.display = "block";
		myList_2.style.display = "none";
	}
	});

	toggleButton_2.addEventListener("click", function() {
	if (myList_2.style.display === "none") {
		myList_2.style.display = "block";
	...
	thead.append("tr")
		.selectAll("th")
		.data(["region", "country", "all_abortion_costs_service","all_abortion_costs_safe","all_abortion_costs_lesssafe"])
		.enter()
		.append("th")
    ...
    var cells = rows.selectAll("td")
        .data(function(row) {
            return ["category", "country", "all_abortion_costs_service","all_abortion_costs_safe","all_abortion_costs_lesssafe"].map(function(column) {
	...
	d3.select("#sort-button5").on("click", function() {
	...
	sortButton5 = d3.select("#sort-button5");
	...
	sortButton5.on("click", function() {
		sortTable("all_abortion_costs_lesssafe");
		toggleArrow(sortButton5);
	});
